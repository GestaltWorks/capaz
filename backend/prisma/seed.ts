...
async function main() {
  ...
  const mspSkillData = [
    ...
    },
    {
      ...
      skills: [
        { name: 'Proofpoint', description: 'Email gateway, TAP, threat response, archiving' },
        { name: 'Mimecast', description: 'Email security, continuity, archiving, awareness training' },
        { name: 'Avanan / Check Point', description: 'API-based email security for M365 and Google' },
        { name: 'Barracuda', description: 'Email gateway, backup, archiving' },
        { name: 'Microsoft Defender for Office 365', description: 'Safe Links, Safe Attachments, anti-phishing policies' },
        { name: 'Email Authentication', description: 'SPF, DKIM, DMARC configuration and monitoring' },
        { name: 'Email Encryption', description: 'Message encryption, secure portals, compliance' },
        { name: 'Email Archiving & eDiscovery', description: 'Retention policies, legal hold, compliance search' },
        { name: 'Phishing Investigation', description: 'Analyzing reported emails, threat assessment' },
        { name: 'Business Email Compromise Response', description: 'BEC detection, containment, recovery' },
      ],
    },
    {
      ...
      skills: [
        { name: 'SIEM Platforms', description: 'Microsoft Sentinel, Splunk, LogRhythm, Elastic' },
        { name: 'Log Collection & Aggregation', description: 'Syslog, event forwarding, log sources' },
        { name: 'Alert Triage', description: 'Analyzing security alerts, true vs false positive' },
        { name: 'Threat Hunting', description: 'Proactive search for indicators of compromise' },
        { name: 'Incident Investigation', description: 'Timeline reconstruction, evidence gathering' },
        { name: 'Forensic Fundamentals', description: 'Disk imaging, memory analysis, chain of custody' },
        { name: 'Threat Intelligence', description: 'IOC feeds, threat actor tracking, intelligence sharing' },
        { name: 'Security Reporting', description: 'Executive summaries, metrics, trend analysis' },
        { name: 'Runbook Development', description: 'Standardized response procedures' },
        { name: 'On-Call Security Response', description: 'After-hours incident handling' },
      ],
    },
    {

  ...
  const mspSkillData = [
    // ===== SERVICE DELIVERY =====
    {
      ...
      skills: [
        ...
        { name: 'Remote Support Sessions', description: 'Screen sharing, remote control, file transfer, session handoff' },
    ...
    },
    {
      ...
      skills: [
        { name: 'Ticket Lifecycle Management', description: 'Creation, triage, assignment, escalation, resolution workflows' },
        { name: 'Time Entry & Billing Integration', description: 'Accurate time capture tied to agreements and invoicing' },
        { name: 'Service Agreement Configuration', description: 'Recurring contracts, SLAs, covered vs billable work' },
        { name: 'Workflow Automation', description: 'Auto-routing, escalation rules, status triggers, notifications' },
        { name: 'Configuration & Asset Tracking', description: 'Linking tickets to devices, contacts, and documentation' },
        { name: 'Board & Queue Management', description: 'Organizing ticket flow for team efficiency' },
        { name: 'PSA Reporting & Dashboards', description: 'Utilization, SLA compliance, backlog analysis' },
        { name: 'Integration Management', description: 'Connecting PSA with RMM, documentation, billing systems' },
        { name: 'Client Portal Administration', description: 'Self-service ticket submission and status visibility' },
        { name: 'PSA Data Hygiene', description: 'Maintaining clean contacts, companies, and configurations' },
      ],
    },
    {
      ...
      skills: [
        { name: 'Agent Deployment & Health', description: 'Installation, coverage verification, offline agent remediation' },
        { name: 'Monitoring Policy Design', description: 'Thresholds, conditions, and alerting logic' },
        { name: 'Alert Tuning & Noise Reduction', description: 'Balancing sensitivity with actionable alerts' },
        { name: 'Patch Policy Management', description: 'Approval workflows, scheduling, compliance reporting' },
        { name: 'Script Development & Deployment', description: 'Automation scripts pushed to managed endpoints' },
        { name: 'Custom Monitor Creation', description: 'Building monitors for client-specific applications' },
        { name: 'Endpoint Inventory & Reporting', description: 'Hardware, software, compliance dashboards' },
        { name: 'Remote Access Administration', description: 'Secure access configuration and session management' },
        { name: 'Maintenance Window Scheduling', description: 'Coordinating automated tasks with business hours' },
        { name: 'Multi-Tenant Management', description: 'Organizing clients, sites, and policy inheritance' },
      ],
    },
    {
      ...
      skills: [
        { name: 'Documentation Platform Administration', description: 'Structure, templates, access control, integrations' },
        ...
        { name: 'Knowledge Capture', description: 'Documenting undocumented systems and tribal knowledge' },
        ...
        { name: 'Diagram Creation', description: 'Network topology, process flows, architecture visuals' },
        { name: 'Configuration Tracking', description: 'Recording system settings, licenses, vendor contacts' },
        { name: 'Documentation Standards', description: 'Templates, naming conventions, quality requirements' },
      ],
    },
    ...
    // ===== TECHNICAL ENGINEERING =====
    {
      ...
      skills: [
        ...
        { name: 'Conditional Access Policy Design', description: 'Identity-based access rules, MFA enforcement, compliance' },
        { name: 'SharePoint Administration', description: 'Site architecture, permissions, storage, hub sites' },
        { name: 'Teams Governance', description: 'Team lifecycle, guest access, policies, calling/voice' },
        { name: 'License Optimization', description: 'Right-sizing subscriptions, cost management, feature alignment' },
        { name: 'Multi-Tenant Management', description: 'Partner admin relationships, delegated access, bulk operations' },
        { name: 'Graph API & PowerShell Automation', description: 'Scripted administration, reporting, bulk changes' },
        { name: 'Identity & Access Management', description: 'User lifecycle, groups, SSO, hybrid identity sync' },
        { name: 'Mobile Device Management', description: 'Device policies, app deployment, compliance enforcement' },
      ],
    },
    {
      name: 'Endpoint Security',
      description: 'EDR, threat detection, and endpoint protection',
      skills: [
        { name: 'EDR Deployment & Policy', description: 'Agent rollout, exclusions, protection policies' },
        { name: 'Threat Investigation', description: 'Analyzing detections, determining scope, root cause' },
        { name: 'Malware Remediation', description: 'Containment, cleanup, system recovery' },
        { name: 'Application Control', description: 'Whitelisting, ringfencing, execution policies' },
        { name: 'DNS-Layer Security', description: 'Web filtering, category blocking, threat protection' },
        { name: 'Security Awareness Programs', description: 'Phishing simulations, training campaigns, behavior change' },
        { name: 'Vulnerability Scanning', description: 'Discovery, prioritization, remediation tracking' },
        { name: 'Endpoint Hardening', description: 'Attack surface reduction, baseline configurations' },
        { name: 'Privilege Management', description: 'Least privilege, elevation control, admin rights' },
        { name: 'Security Policy Standardization', description: 'Consistent protection across client environments' },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        { name: 'Image-Based Backup', description: 'Full system capture, bare-metal recovery capability' },
        { name: 'Backup Job Configuration', description: 'Schedules, retention, source selection, exclusions' },
        { name: 'Recovery Testing', description: 'Scheduled restore verification and documentation' },
        { name: 'Offsite Replication', description: '3-2-1 compliance, cloud targets, geographic redundancy' },
        { name: 'RTO/RPO Planning', description: 'Recovery objectives aligned to business requirements' },
        { name: 'SaaS Data Protection', description: 'Backup for cloud applications beyond native retention' },
        { name: 'Disaster Recovery Execution', description: 'Failover procedures, virtualization, DR testing' },
        { name: 'Immutable Backup Strategy', description: 'Ransomware-resistant configurations, air-gapped copies' },
        { name: 'Backup Monitoring & Alerting', description: 'Job success verification, failure remediation' },
        { name: 'Recovery Documentation', description: 'Runbooks for restore procedures by system type' },
      ],
    },
    {
      ...
      skills: [
        { name: 'Firewall Administration', description: 'Rules, NAT, security policies, firmware management' },
        { name: 'Switch Configuration', description: 'VLANs, trunking, port security, PoE management' },
        { name: 'Wireless Network Design', description: 'Site surveys, channel planning, coverage optimization' },
        { name: 'Network Troubleshooting', description: 'Connectivity issues, latency, packet analysis' },
        { name: 'ISP Coordination', description: 'Circuit troubleshooting, escalation, handoff issues' },
        { name: 'Network Remediation', description: 'Addressing inherited misconfigurations and technical debt' },
        { name: 'VPN Configuration', description: 'Site-to-site tunnels, client VPN, remote access' },
        { name: 'SD-WAN Implementation', description: 'Multi-site connectivity, failover, traffic policies' },
        { name: 'Network Segmentation', description: 'VLAN design, guest isolation, IoT separation' },
        { name: 'Network Documentation', description: 'Topology diagrams, IP schemes, change tracking' },
      ],
    },
    ...
    // ===== DATA & SOFTWARE =====
    {
      ...
      skills: [
        { name: 'Accounting Software Support', description: 'Troubleshooting, updates, data file management' },
        { name: 'CRM Administration', description: 'User setup, customization, integration support' },
        { name: 'Practice Management Support', description: 'Vertical-specific application troubleshooting' },
        { name: 'Document Management Systems', description: 'Structure, permissions, workflow configuration' },
        { name: 'Application Integration', description: 'API connections, data sync, middleware configuration' },
        { name: 'Legacy Application Support', description: 'Compatibility workarounds, virtualization, migration planning' },
        { name: 'Software Licensing Management', description: 'Compliance tracking, renewals, optimization' },
        { name: 'Application Packaging & Deployment', description: 'Silent installs, automated rollouts' },
        { name: 'SaaS Administration', description: 'User provisioning, settings, vendor coordination' },
        { name: 'Application Performance Troubleshooting', description: 'Slowness, errors, resource issues' },
      ],
    },
    {
      ...
      skills: [
        { name: 'Database Installation & Configuration', description: 'Setup, security, initial configuration' },
        { name: 'Database Maintenance', description: 'Index optimization, integrity checks, log management' },
        { name: 'Database Backup & Recovery', description: 'Backup strategies, point-in-time recovery, testing' },
        { name: 'Data Migration', description: 'Moving data between systems, format conversion, validation' },
        { name: 'Report Development', description: 'Building reports, dashboards, data visualization' },
        { name: 'Data Import/Export', description: 'ETL processes, file transfers, API data exchange' },
        { name: 'Query Optimization', description: 'Performance tuning, indexing, execution plan analysis' },
        { name: 'Data Quality Management', description: 'Deduplication, validation, cleanup processes' },
      ],
    },
    ...
    // ===== AUTOMATION & INTEGRATION =====
    {
      ...
      skills: [
        { name: 'PowerShell Scripting', description: 'Windows, M365, Active Directory, Azure automation' },
        { name: 'Workflow Automation Platforms', description: 'No-code/low-code automation design and maintenance' },
        { name: 'Ticket Workflow Automation', description: 'Auto-routing, escalation, status updates, notifications' },
        { name: 'Endpoint Script Deployment', description: 'Scheduled scripts, remediation, configuration' },
        { name: 'API Integration Development', description: 'Connecting tools, data sync, custom integrations' },
        ...
        { name: 'Process Improvement Analysis', description: 'Identifying manual work that should be automated' },
        { name: 'Cross-Platform Scripting', description: 'Python, Bash, automation beyond Windows' },
      ],
    },
